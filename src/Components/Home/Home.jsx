    ...
    <ToastContainer/>
      ...
      <div className="justify-center py-12 sm:flex">
        ...
        >
          ...
          <Link className="flex  justify-center text-slate-200 gap-3 items-center bg-[#12AEE7] hover:bg-slate-400 w-[98%] h-12 rounded-[30px]">
      ...
      <div
        ...
        >
          <h1 className="font-[500px]  text-2xl text-center text-white font-[200px] uppercase ">
            Say something{" "}
          </h1>
          <div className="">
          ...
          <button
            ...
            className="flex justify-center items-center text-white font-[800px] gap-3 bg-[#7B8398] hover:bg-slate-600  h-14 rounded-[30px]"
          >
            Submit
          </button>
        </div>
      ...
      <div className="">
        <h1 className="font-sans font-[500px] text-xl uppercase text-center  text-[#12AEE7] py-3">
          Our partenership
        </h1>
        <p className="font-sans text-[15px] text-center text-slate-500">
          We showcase our dedication to fostering impactful partnerships that
          advance our mission. 
        </p>
        <p className="font-sans text-center text-[15px] text-slate-500">
