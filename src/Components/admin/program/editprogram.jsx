...
const navigate = useNavigate(); 
  ...
  const fetchCourses = () => {
    ...
    axios({
      method: "GET",
      url: `https://afri-code-back-end-zeo6.onrender.com/api/course/findCourse/?id=${courseId}`,
    }).then((response) => {
  ...
  const handleForm = (e) => {
    ...
    axios
      .put(`https://afri-code-back-end-zeo6.onrender.com/api/course/UpdateCourse?id=${courseId}`, form)
      .then((response) => {
  ...
  return (
    <>
      <div className="relative ml-[16rem] flex flex-col w-full min-w-0 mb-6 break-words border-0 rounded-lg shadow-lg font-sora bg-blueGray-100 ">
        <ToastContainer />
              ...
              <div className="w-full px-4 lg:w-6/12">
                <div className="relative w-full mb-3 ">
                  ...
                  <input
                    ...
                    placeholder="lucky.jesse"
                    value={courseTeacher}
                    onChange={(e) => {courseTeacher(e.target.value)}}
                  />
                </div>
              </div>
              <div className="w-full px-4 lg:w-6/12">
